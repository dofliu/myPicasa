...
# -*- coding: utf-8 -*-
"""
myPicasa - 圖片與影片整理工具 (現代化美化版)

這是最新的美化版本，採用現代化 UI 設計：
- 深色/淺色主題切換
- 圓角按鈕和卡片設計
- 流暢的動畫效果
- 更好的視覺層次
...
class ModernImageTool(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle(f"🎨 {Config.APP_NAME} - 現代化版本")
        self.resize(1000, 700)  # 更大的預設視窗
    ...
    def _create_image_tab(self):
        ...
        # 檔案選擇區
        file_group = self._create_group_box("📁 選擇圖片檔案")
    ...
    def _create_video_tab(self):
        ...
        # 檔案選擇區
        file_group = self._create_group_box("📹 選擇影片檔案")
        file_layout = QVBoxLayout()
        ...
        file_layout.addWidget(btn_select_videos)
    ...
    def _create_convert_image_tab(self):
        ...
        # 檔案選擇區
        file_group = self._create_group_box("📁 選擇要轉換的圖片")
        file_layout = QVBoxLayout()
